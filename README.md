...
- [Memxus](https://github.com/gpitrella/memxus-remote-mcp) - Your memory travels with you. Save context once in any AI tool, recall it instantly across Claude, ChatGPT, Cursor, VS Code, Gemini, Telegram and more. OAuth 2.1 PKCE, AES-256 encrypted, RFC 9728 compliant. (🏷️ `TypeScript` `Cloud` `MCP` `OAuth`)
